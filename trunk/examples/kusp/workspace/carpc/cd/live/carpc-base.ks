...
repo --name=release --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=fedora-11&arch=$basearch
...
repo --name=local --baseurl=/home/tphagan/carpc/cd/local_repo
...
# Turn off stuff the carpc will never use
chkconfig --level 345 sendmail off 2>/dev/null
