 ...
 *
 * @param rdwrp Uninitialized pthread_rdwr_t
 * @param attrp Unused
 * @retval 0
 */
...
/**
 * Lock (as reader). Will block on writers writing.
 *
 * @param rdwrp Mutex to lock
 * @retval 0
 */
...
/**
 * Lock (as writer). Will block on writers writing or readers reading.
 *
 * @param rdwrp Mutex to lock
 * @retval 0
 */
