...
def run_distutils():
    """Executes the distutils scripts that build
    and install the datastreams modules."""
    print sys.argv
    
    from distutils.core import setup, Extension
    
    libdsui_dir = "dsui/%s"%Params.cmake_binary_dir
    libkusp_dir = "../common/%s"%Params.cmake_binary_dir
    
    pydsui_backend_module = Extension('_pydsui_backend',
    ...
    dsui_module = Extension('dsui_mod',
    ...
    dski_module = Extension('dski_mod',
            ...
            library_dirs = [ Params.cmake_binary_dir+'/lib'] )
       
    setup(name = "datastreams",
          version = "1.0",
          ...
          packages = ["datastreams",
                    "datastreams.postprocess",
                    "datastreams.postprocess.filters" ],
