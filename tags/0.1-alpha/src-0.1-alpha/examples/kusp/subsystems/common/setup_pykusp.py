#! /bin/env python
"""
:program:`setup_pykusp.py`
===========================
    :synopsis: Executes the distutils code for building/installing the pykusp package.
...
This script wraps the old setup script with the new setup_module.py.tpl
...
def run_distutils():
    ...
    setup(name = "pykusp",
          ...
          scripts = ["pykusp/trace-me",
                     'pykusp/testparser',
                     'pykusp/metaparser'],
          packages = ["pykusp","pykusp.parsers", "pykusp.devutils"]
          )
    pass
...
## of the distutils setups to ensure that they run. These
## are normally used when creating scripts that are not 
## 'pure Python' modules that used compiled libraries and the like.
##            
