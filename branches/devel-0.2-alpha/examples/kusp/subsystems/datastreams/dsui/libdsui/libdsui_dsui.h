...
#ifndef libdsui_LOCAL_DSUI_H
#define libdsui_LOCAL_DSUI_H
...
extern struct datastream_ip __start___libdsui_datastream_ips[];
extern struct datastream_ip __stop___libdsui_datastream_ips[];

#define DSUI_BEGIN(argcp, argvp) \
	dsui_start((argcp), (argvp), "/tmp/libdsui.dsui.bin");
...
#define DSTRM_EVENT_DATA(gname, ename, tag, data_len, data, edfname) do {	\
	...
	__attribute__((section("__libdsui_datastream_ips"), aligned(8))) =			\
	{									\
