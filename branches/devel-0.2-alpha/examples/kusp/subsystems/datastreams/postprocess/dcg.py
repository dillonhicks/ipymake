...
def get_edge_wtype(DCG, type, u, v=None):
	for edge in DCG.edges(u, data=True):
...
def oca_fork(DCG, OCA):
	...
	if DCG.has_node(parent_tag):
		...
		DCG.add_edge(parent_tag, child_tag,key="1",**edge_attr)
...
def oca_root_fd(DCG, OCA):
	...
	DCG.add_edge(root_tag, pc_tag, key="1",**edge_attr)	
...
def oca_signal_send(DCG, OCA):
    ...
    if DCG.has_node(sender_tag):
        ...
        DCG.add_edge(sender_tag, receiver_tag,key="1",**edge_attr)
    else:
	...
	if DCG.has_node(reader_tag):
		...
		if DCG.has_node(pc_tag):
			...
			if read_edge:
				...
				DCG.add_edge(pc_tag, reader_tag, edge_attr)
		else:
	...
	if DCG.has_node(receiver_tag):
		...
		if DCG.has_node(pc_tag):
			...
			if receiver_edge:
				...
				DCG.add_edge(pc_tag, receiver_tag, edge_attr)
		else:
...
FILE_NODE_DRAW_PARAMS       = {DCG_DP_NODE_SIZE  : 700,  DCG_DP_NODE_ALPHA : 1.0, DCG_DP_NODE_SHAPE : 's', DCG_DP_NODE_COLOR : "brown"}
...
FORK_EDGE_DRAW_PARAMS       = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "r" }
                            
PARENT_EDGE_DRAW_PARAMS     = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "b" }
CHILD_EDGE_DRAW_PARAMS      = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "g" }
DESCENDANT_EDGE_DRAW_PARAMS = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "k" }
ANCESTOR_EDGE_DRAW_PARAMS   = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "m" }
                            
SIGNAL_EDGE_DRAW_PARAMS     = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dashed", DCG_DP_EDGE_COLOR : "b" }
IN_FD_EDGE_DRAW_PARAMS      = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dashed", DCG_DP_EDGE_COLOR : "g" }
IN_SHM_EDGE_DRAW_PARAMS     = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dashed", DCG_DP_EDGE_COLOR : '#FF0080' }
OPEN_EDGE_DRAW_PARAMS       = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "g" }
CLOSE_EDGE_DRAW_PARAMS      = {DCG_DP_EDGE_ALPHA : 0.5, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "solid",  DCG_DP_EDGE_COLOR : "g" }
READ_EDGE_DRAW_PARAMS       = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dashed", DCG_DP_EDGE_COLOR : "m" }
WRITE_EDGE_DRAW_PARAMS      = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dashed", DCG_DP_EDGE_COLOR : "m" }
LOCK_EDGE_DRAW_PARAMS       = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dotted", DCG_DP_EDGE_COLOR : "g" }
UNLOCK_EDGE_DRAW_PARAMS     = {DCG_DP_EDGE_ALPHA : 0.5, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "solid",  DCG_DP_EDGE_COLOR : "g" }
USE_EDGE_DRAW_PARAMS        = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "dashed", DCG_DP_EDGE_COLOR : '#804000' }

MASTER_EDGE_DRAW_PARAMS     = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "solid", DCG_DP_EDGE_COLOR : "m" }
SLAVE_EDGE_DRAW_PARAMS      = {DCG_DP_EDGE_ALPHA : 1.0, DCG_DP_EDGE_WIDTH  : 2, DCG_DP_EDGE_STYLE : "solid", DCG_DP_EDGE_COLOR : "g" }
...
#########################################################################
    ...
    def construct_lists(self, DCG, input_node_attributes):
        ...
        for edge in DCG.edges(data=True):
